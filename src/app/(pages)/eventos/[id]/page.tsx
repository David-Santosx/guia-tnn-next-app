...
import { Calendar, Clock, MapPin, Building, User, ArrowLeft } from "lucide-react";
...
async function getEventById(id: string): Promise<Event | null> {
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL || ""}/api/eventos/${id}`);
...
export default async function EventoDetalhePage({ params }: { params: { id: string } }) {
  ...
  const formattedCreatedAt = format(parseISO(event.createdAt), "dd/MM/yyyy 'às' HH:mm", { locale: ptBR });
          ...
          <div className="p-6 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2 space-y-6">
                <div>
                  <h2 className="text-xl font-semibold text-brand-blue mb-3">Sobre o evento</h2>
                  <p className="text-gray-700 whitespace-pre-line">{event.description}</p>
                </div>
                
                <div>
                  <h2 className="text-xl font-semibold text-brand-blue mb-3">Organização</h2>
              ...
              <div className="bg-gray-50 rounded-lg p-5 space-y-5">
                <div>
                  <h3 className="font-medium text-brand-blue mb-3">Informações</h3>
                ...
                <div className="border-t pt-4">
                  <h3 className="font-medium text-brand-blue mb-3">Publicado por</h3>
                  <div className="flex items-center text-gray-700">
