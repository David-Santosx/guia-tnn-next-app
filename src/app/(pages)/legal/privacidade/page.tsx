          ...
          <div className="prose prose-blue max-w-none text-black space-y-6">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 list-disc pl-6">
                <li>
                  ...
                  endereço de e-mail, número de telefone, quando você se
                  registra ou entra em contato conosco.
                </li>
                <li>
                  <strong>Informações não pessoais:</strong> Dados de uso,
                  endereço IP, tipo de navegador, tempo gasto no site, páginas
                  visitadas.
                </li>
                <li>
                  <strong>Cookies e tecnologias semelhantes:</strong> Utilizamos
                  cookies para melhorar sua experiência de navegação e entender
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 list-disc pl-6">
                ...
                <li>
                  Detectar, prevenir e resolver problemas técnicos ou de
                  segurança.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 list-disc pl-6">
                ...
                <li>
                  Em conexão com uma fusão, venda de ativos ou outra transação
                  comercial.
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p>
                ...
                direitos relacionados às suas informações pessoais, incluindo:
              </p>
              <ul className="space-y-2 list-disc pl-6">
            ...
            <div className="space-y-4">
              ...
              <p>
                ...
                para os fins estabelecidos nesta Política de Privacidade, a
            ...
            <div className="space-y-4">
              ...
              <p>
                Nosso site não é direcionado a menores de 13 anos e não
                coletamos intencionalmente informações pessoais de crianças. Se
                você acredita que coletamos informações de uma criança, entre em
            ...
            <div className="space-y-4">
              ...
              <p>
                ...
                Notificaremos sobre quaisquer alterações publicando a nova
                política em nosso site e, quando apropriado, notificando você
                por e-mail.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p>
                ...
                em contato conosco pelo e-mail: guiatnn@hotmail.com
              </p>
            </div>
          </div>
        </div>
