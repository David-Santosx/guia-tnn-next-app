...
export default function CollaborateButton() {
  return (
    ...
    >
      ...
      <span className="font-medium">Colabore com Fotos</span>
      <div className="absolute -top-2 -right-2 w-4 h-4 bg-brand-orange rounded-full animate-ping" />
      <div className="absolute -top-2 -right-2 w-4 h-4 bg-brand-orange rounded-full" />
    </Link>
  );
}
